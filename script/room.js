...
var Room = {
	...
	_STOKE_COOLDOWN: .0000001, // cooldown to stoke the fire
	_NEED_WOOD_DELAY: 15 * .00000000000000000000000001, // from when the stranger shows up, to when you need wood
	buttons: {},
	Craftables: {
		'trap': {
			name: _('trap'),
